...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"deu-hbx","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../webpack/buildin/global.js */ 2), __webpack_require__(/*! ./../webpack/buildin/module.js */ 13)(module)))
...
/***/ 14:
/*!****************************************************************!*\
  !*** E:/P11/home-work/Home-work/HBX-01/deu-hbx/store/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _storage = _interopRequireDefault(__webpack_require__(/*! @/utils/storage.js */ 15));



var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 4));

var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // vuex
// 本地
//引入vue和vuex
...
var TOKEN_KEY = "token"; // token
var USERINFO_KEY = "userInfo"; //用户信息

// 全局变量定义
var store = new _vuex.default.Store({

  state: {
    token: _storage.default.getItem(TOKEN_KEY) || '',
    userInfo: _storage.default.getItem(USERINFO_KEY) || '{}' },
  ...
  mutations: {
    ...
    SETUSERINFO: function SETUSERINFO(state, userInfo) {
      ...
      _storage.default.setItem(TOKEN_KEY, state.userInfo.token);
      _storage.default.setItem(USERINFO_KEY, JSON.stringify(state.userInfo));
    } },
...
/***/ 15:
/*!******************************************************************!*\
  !*** E:/P11/home-work/Home-work/HBX-01/deu-hbx/utils/storage.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 本地存储
...
// 删
var remoteItem = function remoteItem(key) {
...

{
  ...
  getItem: getItem,
  clearAll: clearAll,
  remoteItem: remoteItem };exports.default = _default;
...
/***/ 26:
/*!******************************************************************!*\
  !*** E:/P11/home-work/Home-work/HBX-01/deu-hbx/utils/request.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 请求

var baseURL = "http://demonuxtapi.dishait.cn";


var http = function http(data) {
  return new Promise(function (resolve, reject) {
    var appid = "bd9d01ecc75dbbaaefce";
    uni.request({
...
IndexModel = /*#__PURE__*/function (_Http) {_inherits(IndexModel, _Http);var _super = _createSuper(IndexModel);function IndexModel() {_classCallCheck(this, IndexModel);return _super.apply(this, arguments);}_createClass(IndexModel, null, [{ key: "getMobileIndex",
    ...
    // 获取拼团列表   秒杀列表  
  }, { key: "getGroupFlashsale", value: function getGroupFlashsale(type, data) {
      return _http.default.request({
        url: '/mobile/' + type,
        method: 'GET',
        data: data });
...
var Http = /*#__PURE__*/function () {function Http() {_classCallCheck(this, Http);}_createClass(Http, null, [{ key: "_beforeRequest",
    ...
    // 请求拦截
    value: function () {var _beforeRequest2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(config) {var token;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                // 获取vuex中token
                ...
                // }
                if (
                token) {_context.next = 3;break;}return _context.abrupt("return");case 3:
                // config.header = {
                // 	appid: Config.appid,
                // 	token
                // }
                ...
                return _context.abrupt("return", config);case 5:case "end":return _context.stop();}}}, _callee);}));function _beforeRequest(_x) {return _beforeRequest2.apply(this, arguments);}return _beforeRequest;}()
    ...
    //  http 请求   static request(options) {
                ...
                //  请求
                _context2.next = 9;return uni.request(config);case 9:response = _context2.sent; // return res[1].data
                console.log('response', response);
                // 调用  响应拦截函数
                _context2.next = 13;return Http._beforeResponse(response);case 13:return _context2.abrupt("return", _context2.sent);case 14:case "end":return _context2.stop();}}}, _callee2);}));function request(_x2) {return _request.apply(this, arguments);}return request;}()
    ...
    // 错误的 信息提示
      ...
      title = _exception.default[code] || msg || '发生未知错误'; // title = exceptionMessage[code] || res || '发生未知错误'
...
/***/ 5:
/*!************************************************************!*\
  !*** E:/P11/home-work/Home-work/HBX-01/deu-hbx/pages.json ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 53:
/*!********************************************************************!*\
  !*** E:/P11/home-work/Home-work/HBX-01/deu-hbx/model/userModel.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 类继承   static 可转静态(不转需要 new 一个实例化)
var UserModel = /*#__PURE__*/function (_Http) {_inherits(UserModel, _Http);var _super = _createSuper(UserModel);function UserModel() {_classCallCheck(this, UserModel);return _super.apply(this, arguments);}_createClass(UserModel, null, [{ key: "getToLogin",

    // 登录接口
    value: function getToLogin(data) {
      return _http.default.request({
        url: '/mobile/login',
        method: 'POST',
        data: data });
    ...
    // 账号注册
  }, { key: "getRegister", value: function getRegister(data) {
      return _http.default.request({
        url: '/mobile/reg',
        method: 'POST',
        data: data });
  ...
  }, { key: "getBindMobile", value: function getBindMobile() {
      return _http.default.request({
  ...
  }]);return UserModel;}(_http.default);var _default =
